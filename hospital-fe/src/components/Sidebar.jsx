...
export default function Sidebar() {
  ...
  const newAlerts = unreadCount || 0

  return (
    <aside className="sidebar" style={{ display: 'flex', flexDirection: 'col', justifyContent: 'space-between', height: '100vh' }}>
      <div>
        {/* Brand */}
        <div className="sidebar-brand">
          <div className="sidebar-brand-icon"><IconPulse /></div>
      ...
      {/* SỬA MÀU CHỮ Ở ĐÂY: Chuyển sang tông tối tương phản cao trên nền trắng */}
      <div style={{
